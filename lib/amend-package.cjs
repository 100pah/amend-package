...
function createHelpMessage() {
  return `
    ...
    [Example of amend-package.config.cjs]:
      ...
      module.exports = {
        amenderMap: {
          'some_package_1': ({setPackageJSONAttr, ensureSubPackageJSON, getPackageVersion}) => {
          ...
          'some_package_2': ({setPackageJSONAttr, ensureSubPackageJSON}) => {
            // ...
          },
          // ...
        },
...
async function amendSinglePackage(logTag, pkgName, pkgDirPath, committer, amenderMap) {
  ...
  amenderMap[pkgName]({
    ...
    getPackageVersion: getPackageVersion.bind(null, rootPkgJSONPath),
  });
